<template>
  <button 
  class="relative select-none m-1 disabled:cursor-not-allowed bg-white disabled:bg-gray-300 dark:bg-black text-black dark:text-white disabled:text-gray-500 disabled:opacity-75"
